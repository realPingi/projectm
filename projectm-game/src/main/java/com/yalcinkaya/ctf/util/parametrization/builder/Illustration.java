...
public class Illustration extends SmartRunnable {
    ...
    private void spawnEffect(Location location) {
        world.spawnParticle(Particle.REDSTONE, location, effect.getCount(), effect.getOffset(), effect.getOffset(), effect.getOffset(), new Particle.DustOptions(effect.pop(), 1.0F));
    }
